...
function validBiUrl(value:string){
  try{const url=new URL(value);return url.protocol==="https:"&&url.hostname==="bi.coop.no"&&url.pathname.includes("/BOE/OpenDocument/")}catch{return false}
}
