...
export const normalizeProduct=(raw:string,itemNo?:string)=>{
  ...
  const rules:[RegExp,string,ProductCategory][]=[
    // Interiør – kundevennlige navn. Alle basevarianter får samme canonicalName.
    [/BX ELEGANT MATT/,"Butinox Elegant Matt","Maling / Dekkbeis / Beis"],
    [/BX KLASSISK SM/,"Butinox Klassisk Silkematt","Maling / Dekkbeis / Beis"],
    [/BX PREMIUM MATT/,"Butinox Premium Matt","Maling / Dekkbeis / Beis"],
    [/BX STILF TRE 05/,"Butinox Stilfullt Tre 05","Maling / Dekkbeis / Beis"],
    [/BX STILF TRE 15/,"Butinox Stilfullt Tre 15","Maling / Dekkbeis / Beis"],
    [/BX STILF TRE 40/,"Butinox Stilfullt Tre 40","Maling / Dekkbeis / Beis"],
    [/BUTINOX SUPERDEKK TAK/,"Butinox Superdekk Tak","Maling / Dekkbeis / Beis"],
    [/BX TAK & VEGG/,"Butinox Tak og Vegg","Maling / Dekkbeis / Beis"],
    [/TRESTJ(?:ERNER|\.)? GULVM(?:ALING|AL| )? MATT|TRESTJ\.? GM MATT/,"TreStjerner Gulvmaling Matt","Maling / Dekkbeis / Beis"],
    [/TRESTJ(?:ERNER|\.)? GULVM(?:ALING|AL| )? HALVB|TRESTJ\.? GM HB/,"TreStjerner Gulvmaling Halvblank","Maling / Dekkbeis / Beis"],
    [/TRESTJ GULVMAL PREM/,"TreStjerner Gulvmaling Premium","Maling / Dekkbeis / Beis"],
    [/TRESTJ\.? GULVLAKK MATT/,"TreStjerner Gulvlakk Matt","Maling / Dekkbeis / Beis"],
    [/TRESTJ\.? GULVLAKK HB/,"TreStjerner Gulvlakk Halvblank","Maling / Dekkbeis / Beis"],
    [/TRESTJ SPERREGRUNNING/,"TreStjerner Sperregrunning","Maling / Dekkbeis / Beis"],
    [/LADY PURE COLOR|LADY PURE N INT/,"LADY Pure Color","Maling / Dekkbeis / Beis"],
    [/LADY WONDERW/,"LADY Wonderwall","Maling / Dekkbeis / Beis"],
    [/LADY BALANCE/,"LADY Balance","Maling / Dekkbeis / Beis"],
    [/LADY ESSENCE/,"LADY Essence","Maling / Dekkbeis / Beis"],
    [/LADY PERFECTION/,"LADY Perfection","Maling / Dekkbeis / Beis"],
    [/LADY AQUA/,"LADY Aqua","Maling / Dekkbeis / Beis"],
    [/LADY SUPREME 03/,"LADY Supreme Finish 03","Maling / Dekkbeis / Beis"],
    [/LADY SUPREME 15/,"LADY Supreme Finish 15","Maling / Dekkbeis / Beis"],
    [/LADY SUPREME 40/,"LADY Supreme Finish 40","Maling / Dekkbeis / Beis"],
    [/LADY SUPREME 80/,"LADY Supreme Finish 80","Maling / Dekkbeis / Beis"],
    [/JOTUN VEGG(?: OG|\/)TAK/,"Jotun Vegg og Tak","Maling / Dekkbeis / Beis"],
    [/JOTUN KVIST-?(?: OG )?SP(?:ER)?\.?GR|JOTUN KVIST-SPER\.GR/,"Jotun Kvist- og Sperregrunning","Maling / Dekkbeis / Beis"],
    [/JOTUN HEFTGRUNN/,"Jotun Heftgrunning Universal","Maling / Dekkbeis / Beis"],
    [/JOTUN GRUNNING TAPET/,"Jotun Grunning for Tapet","Maling / Dekkbeis / Beis"],
    [/INFRA SIGNATUR 05/,"Infra Signatur 05","Maling / Dekkbeis / Beis"],
    [/INFRA CLASSIC 01/,"Infra Classic 01","Maling / Dekkbeis / Beis"],
    [/INFRA INT VEGG 10/,"Infra Interiør Vegg 10","Maling / Dekkbeis / Beis"],
    [/INFRA (?:INT & PANEL|TRE & PANEL) 15/,"Infra Tre og Panel 15","Maling / Dekkbeis / Beis"],
    [/INFRA (?:INT & PANEL|TRE & PANEL) 40/,"Infra Tre og Panel 40","Maling / Dekkbeis / Beis"],
    [/INFRA TAK 02/,"Infra Tak 02","Maling / Dekkbeis / Beis"],
    [/INFRA SP\.?GRUNN/,"Infra Sperregrunning","Maling / Dekkbeis / Beis"],
    [/INFRA VÅTROM 05/,"Infra Våtrom 05","Maling / Dekkbeis / Beis"],

    // Terrasse – farger og baser samles per produktserie og spannstørrelse.
    [/TREBITT TER(?:R)? BEIS|TREBITT TERR BEIS/,"Trebitt Terrassebeis","Maling / Dekkbeis / Beis"],
    [/TREBITT OLJEB TERR/,"Trebitt Oljebeis Terrasse","Maling / Dekkbeis / Beis"],
    [/BX MALING TERRASSE/,"Butinox Terrassemaling","Maling / Dekkbeis / Beis"],
    [/BX TERR(?:ASSE)?\.?BEIS/,"Butinox Terrassebeis","Maling / Dekkbeis / Beis"],
    [/TYRILIN TERR\.?BEIS/,"Tyrilin Terrassebeis","Maling / Dekkbeis / Beis"],
    [/INFRA TERR\.?B 3ÅR/,"Infra Terrassebeis 3 år","Maling / Dekkbeis / Beis"],
    [/INFRA TERR\.?B (?:OB )?5ÅR|INFRA TERR\.?B 5ÅR/,"Infra Terrassebeis 5 år","Maling / Dekkbeis / Beis"],
    [/INFRA TREOLJE/,"Infra Treolje","Maling / Dekkbeis / Beis"],
    [/BRYGGE & TERRASSEOLJE/,"Brygge- og Terrasseolje","Maling / Dekkbeis / Beis"],
    [/ROYALOLJE TERRASSE/,"Royalolje Terrasse","Maling / Dekkbeis / Beis"],
    [/SIOOX TERRASSE 01/,"SiOO:X Terrasse 01","Maling / Dekkbeis / Beis"],
    [/SIOOX TERRASSE 02/,"SiOO:X Terrasse 02","Maling / Dekkbeis / Beis"],
